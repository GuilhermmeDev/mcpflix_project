...
export default function Sidebar() {
  return (
    <aside className="md:max-h-full md:sticky max-h-24 w-fit min-w-16 md:ml-8 my-4 md:my-8 bg-neutral-800 rounded-3xl p-4 flex md:flex-col items-center sm:w-fit flex-row fixed bottom-2">
      <Image
